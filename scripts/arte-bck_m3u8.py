...
# URL source
url = "https://raw.githubusercontent.com/Paradise-91/ParaTV/main/streams/tf1plus/arte.m3u8"

# Dossier et fichier de sortie
FHD_OUTPUT_DIR = "./Streams"
FHD_OUTPUT_FILE = "arte-bck.m3u8"
...
try:
    ...
    if response.status_code == 200:
        ...
        if urls_sans_suffixe:
            ...
            fhd_content = generate_m3u_content(m3u8_url, "1280x720", 4277000, "5.m3u8", "29_0.m3u8")
            ...
            log("❌ Aucune URL contenant '1.m3u8' trouvée.")
            sys.exit(1)
    else:
