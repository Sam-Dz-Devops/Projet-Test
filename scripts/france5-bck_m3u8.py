...
# URL source
url = "https://raw.githubusercontent.com/Paradise-91/ParaTV/main/streams/francetv/france-5.m3u8"

# Dossier et fichier de sortie
FHD_OUTPUT_DIR = "./Streams"
FHD_OUTPUT_FILE = "france5-bck.m3u8"
...
try:
    ...
    if response.status_code == 200:
        ...
        if urls_sans_suffixe:
            ...
            log("❌ Aucune URL contenant '5.m3u8' trouvée.")
            sys.exit(1)
    else:
