...
# URL source
url = "https://raw.githubusercontent.com/Paradise-91/ParaTV/main/streams/nrj/cherie25.m3u8"

# Dossier et fichier de sortie
FHD_OUTPUT_DIR = "./Streams"
FHD_OUTPUT_FILE = "cherie25.m3u8"
...
try:
    ...
    if response.status_code == 200:
        ...
        if urls_m3u8:
            ...
            log("❌ Aucune URL contenant 'master.m3u8' trouvée.")
            sys.exit(1)
    else:
