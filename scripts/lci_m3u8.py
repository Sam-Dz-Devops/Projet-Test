...
# URL source
url = "https://raw.githubusercontent.com/Paradise-91/ParaTV/main/streams/tf1plus/res/lci-highest.m3u8"

# Dossier et fichier de sortie
FHD_OUTPUT_DIR = "./Streams"
FHD_OUTPUT_FILE = "lci.m3u8"
...
try:
    ...
    if response.status_code == 200:
        ...
        # Extraction des URLs contenant '1.m3u8'
        ...
        if urls_sans_suffixe:
            ...
            fhd_content = generate_m3u_content(m3u8_url, "1280x720", 4277000, "1.m3u8", "13_0.m3u8")
